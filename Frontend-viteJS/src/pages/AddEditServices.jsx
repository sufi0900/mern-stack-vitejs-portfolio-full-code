...
const AddEditServices = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (ServicesData.title && ServicesData.description) {
      // Check if the user has already added Services information
      const userHasServices = userServicess.some(
        (Services) => Services.name === user?.result?.name
      );

      if (userHasServices && !id) {
        // User has already added Services information, and it's an attempt to add new info
        window.alert(
          "You have already added Services information. You cannot add new information."
        );

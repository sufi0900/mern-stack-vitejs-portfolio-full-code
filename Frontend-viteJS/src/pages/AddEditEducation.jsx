...
const AddEditEducation = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      const userHasEducation = userEducations.some(
        (education) => education.name === user?.result?.name
      );

      if (userHasEducation && !id) {
        // User has already added Education information, and it's an attempt to add new info
        window.alert(
          "You have already added Education information. You cannot add new information."
        );
